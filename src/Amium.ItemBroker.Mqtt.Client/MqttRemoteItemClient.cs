...
/// <summary>
/// Provides a reusable remote MQTT ItemBroker client for external and hybrid scenarios.
/// </summary>
public sealed class MqttRemoteItemClient : IAsyncDisposable
{
    ...
    public MqttRemoteItemClient(MqttItemBrokerClientOptions options)
    {
    ...
    public async Task ConnectAsync(CancellationToken cancellationToken = default)
    {
        ...
        var session = new MqttItemBrokerClientSession(_options);
    ...
    public async Task PublishSnapshotAsync(ItemModel item, CancellationToken cancellationToken = default)
    {
        ...
        lock (_sync)
        {
            _publishedBrokerPaths.Add(ItemBrokerItemPath.Resolve(item));
        }
    ...
    public async Task<ItemBrokerAckMessage> UpdateValueAsync(ItemModel item, CancellationToken cancellationToken = default)
    {
        ArgumentNullException.ThrowIfNull(item);
    ...
    private MqttItemBrokerClientSession GetRequiredSession()
    {
        lock (_sync)
        {
