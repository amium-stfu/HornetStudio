...
{
    private readonly Amium.ItemBroker.Mqtt.MqttItemTopicMapper _inner;
    ...
    {
        _inner = new Amium.ItemBroker.Mqtt.MqttItemTopicMapper(baseTopic);
    }
    ...
    /// </summary>
    public string ItemSubscriptionTopic => $"{BaseTopic}/#";
    ...
    public bool TryMapTopic(string topic, out Amium.ItemBroker.Mqtt.MqttTopicMapping mapping)
