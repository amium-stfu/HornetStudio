...
internal sealed class ServiceHostController : IAsyncDisposable
{
    ...
    private MqttItemBrokerHost? _host;

    internal ServiceHostController(MqttItemBrokerOptions options)
    {
        _options = options;
    }
    ...
    internal IItemBroker? Broker => _host?.Broker;
    ...
    internal async Task StartAsync(CancellationToken cancellationToken = default)
    {
        ...
        _host = new MqttItemBrokerHost(_options);
