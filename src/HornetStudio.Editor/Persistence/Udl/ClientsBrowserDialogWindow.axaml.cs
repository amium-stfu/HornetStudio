...
using UdlClientDefinitionDefaults = HornetStudio.Host.Runtimes.Udl.UdlClientDefinitionDefaults;
using UdlClientRuntime = HornetStudio.Host.Runtimes.Udl.UdlClientRuntime;
using UdlClientRuntimeDiagnosticsSnapshot = HornetStudio.Host.Runtimes.Udl.UdlClientRuntimeDiagnosticsSnapshot;
...
public sealed partial class ClientsBrowserDialogWindow : Window, INotifyPropertyChanged
{
    ...
    private async void OnAddDemoClicked(object? sender, RoutedEventArgs e)
    {
        ...
        var ownerItem = CreateDialogOwnerItem(SelectedClient);
