...
Folder-local custom signal resources are now managed outside the canvas widget system:

- ../Persistence/CustomControls/CustomSignalsBrowserControl.axaml(.cs) - browser control for file-backed custom signal definitions
- ../Persistence/CustomControls/CustomSignalsBrowserDialogWindow.axaml(.cs) - browser shell for folder-local custom signals
- ../Persistence/CustomControls/CustomSignalEditorDialogWindow.axaml(.cs) - dialog for creating and editing individual custom signal definitions
- ../Persistence/CustomControls/CustomSignalDefinitionFileCodec.cs - YAML persistence for `Signals/Custom/*.yaml`
- ../Persistence/CustomControls/CustomSignalFormulaEngine.cs - formula evaluation for computed custom signals
