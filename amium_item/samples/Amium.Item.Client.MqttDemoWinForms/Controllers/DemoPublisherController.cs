...
internal sealed class DemoPublisherController : IAsyncDisposable
{
    ...
    internal DemoPublisherController(MqttItemClientOptions options)
    {
        _options = options;

        _temperature = new ItemModel("Temperature", 22.0, "Demo.Sensors");
        _temperature.Properties["unit"].Value = "degC";
        _temperature.Properties["format"].Value = "0.0";
        _temperature["Raw"].Value = "0.0";

        _pressure = new ItemModel("Pressure", 1012.0, "Demo.Sensors");
    ...
    internal async Task StartAsync(CancellationToken cancellationToken = default)
    {
        ...
        _session = new MqttItemClientSession(_options);
    ...
    private async Task RunLoopAsync(MqttItemClientSession session, CancellationToken cancellationToken)
    {
    ...
    private async Task PublishSnapshotsAsync(MqttItemClientSession session, CancellationToken cancellationToken)
    {
