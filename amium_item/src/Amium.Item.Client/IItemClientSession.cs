...
/// </summary>
public interface IItemClientSession : IItemServerClient
{
    /// <summary>
    ...
    Task<ItemServerAckMessage> UpdateValueAsync(ItemModel item, bool retained = false, string? correlationId = null, CancellationToken cancellationToken = default);
