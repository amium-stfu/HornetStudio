...
public abstract record ItemServerMessage(
    string Path,
...
/// </summary>
/// <param name="Path">The canonical item path.</param>
/// <param name="ItemModel">The item snapshot.</param>
...
public sealed record ItemSnapshotMessage(
    ...
    string? CorrelationId,
    DateTimeOffset Timestamp)
    : ItemServerMessage(Path, SourceClientId, CorrelationId, Timestamp);
...
/// </summary>
/// <param name="Path">The canonical item path.</param>
/// <param name="PropertyName">The changed parameter name.</param>
...
public sealed record ItemPropertyChangedMessage(
    string Path,
    string PropertyName,
    object? Value,
    string? SourceClientId,
...
public sealed record ItemServerAckMessage(
    string Path,
    bool Accepted,
    string? Reason,
    string? SourceClientId,
